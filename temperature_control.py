...
#fan = GPIO.PWM(13, 100)
#heating_led = GPIO.PWM(19,100) #(pin number, frequency)
user_interrupt = 0
switch_pressed = 0
...
def temp_pv_function():
   ...
   temp_pv = random.uniform(18, 26)
   temp_pv = round(temp_pv, 1)

   return temp_pv ## returning random value for the purpose of not connecting the physical sensor
